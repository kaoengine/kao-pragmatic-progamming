...
* Document your assumptions. [Design by Contract](_Table%20of%20Content#21-design-by-contract).
* Don't just test your code, but test your assumptions as well. Don't guess [Assertive Programming](_Table%20of%20Content#23-assertive-programming)
* Prioritize your effort.
* Don't be a slave to history. Don't let existing code dictate future code. [Refactoring](_Table%20of%20Content#33-refactoring)
...
* Duplication. You've discovered a violation of the DRY principle ([The Evils of Duplication](_Table%20of%20Content#7-the-evils-of-duplication)).
* Nonorthogonal design. You've discovered some code or design that could be made more orthogonal ([Orthogonality](_Table%20of%20Content#8-orthogonality)).
